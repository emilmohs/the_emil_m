...
export default async function AdminPage({
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-black">
      {/* Modern Header */}
      <header className="bg-white px-8 py-6 shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-gray-900 tracking-tight">Admin Zentrale</h1>
              <p className="text-sm font-medium text-gray-500">Systemverwaltung und Benutzerkontrolle</p>
            </div>
          </div>
          <a 
